    ...
    <div id="wrap" class="sub recruit personnel-system">
        ...
        <div id="container">
            ...
            <div id="contents">
                ...
                <div class="section sec01 sec_full">
                    <div class="sec_inner">
                        <img src="/resource/mobile/images/recruit/img_personnel01.png" alt="">
                        <p class="notice">직위 별 승진자격 기본 년수에 도달한 직원을 대상으로 승진심사를 진행합니다.</p>
                        <p class="notice">역량 ∙ 성과가 탁월한 경우 특별승진 기회가 부여됩니다.</p>
                    </div>
                </div>
                ...
                <div class="section sec03 sec_full recruit_overview">
                    <div class="sec_inner">
                        <div class="tit_wrap">
                            <h4>인재채용 소개</h4>
