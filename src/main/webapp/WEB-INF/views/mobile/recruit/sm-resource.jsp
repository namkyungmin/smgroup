        ...
        <div id="container">
            ...
            <div id="contents">
				<div class="section sec01">
                    <div class="tit_wrap">
                        <h4>SM People</h4>
                        <p class="sub_tit">SM그룹의 인재상은 Vision과 Priorities를 실현하기<br>
                            위해 다음과 같은 능력을 갖춘 사람입니다.</p>
                    </div>
                    <ul>
                        <li>
                    ...
                    <div class="txt">
                        <span>SM그룹의 인재상</span>은 서로 다른 재능이 모여 시너지를 만들고 언제나 새로움에 도전하는 사람을 이야기 합니다.
                    </div>
                </div>
                    ...
                    <div class="sec_inner">
                        <div class="tit_wrap">
                            ...
                            <a href="https://smpeople.recruiter.co.kr/appsite/company/index" target="_blank">
                                채용사이트 바로가기 
                                <span class="btn_arrow"><img src="/resource/mobile/images/common/bg_btn_arrow_r.png" alt=""></span>
                            </a>
                        </div>
