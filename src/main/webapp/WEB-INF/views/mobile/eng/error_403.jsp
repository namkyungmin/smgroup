...
<style>
	...
	.common_btn.type02{background-color:#b01a1d; background-image: url(/resource/eng/mobile/images/common/bg_btn_arrow_w.png); border:none; color:#fff;}
</style>
		...
		<div id="contents">
			<div class="error_cont">
				<div class="cont_inner">
					...
					<div class="btn_wrap">
						<a href="/mobile/eng/index.do" class="common_btn type02"><span>SM그룹 홈페이지</span></a>
					</div>
				</div>
			</div>
		</div>
