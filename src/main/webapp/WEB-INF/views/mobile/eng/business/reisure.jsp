...
<title>Leisure | SM Group | Mobile</title>
</head>
            ...
            <div id="contents">
                ...
                <div class="tab_wrap">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="reisure.do">Leisure</a>
                        </li>
                    </ul>
                </div>
                <!--//e: tab_wrap -->
                <div class="cont_tit">
                    <h3>Luxurious complex resort with culture, art and leisure</h3>
                    <p class="sub_tit">SM Groups provide sophisticated and sophisticated quality services and facilities through the top-notch premium brand in Korea, “TOPS 10”.</p>
                </div>
                <div class="section">
                    <div class="thumb_wrap">
                        <img src="/resource/eng/mobile/images/business/img_business_reisure.jpg" alt="">
                    </div>
                    <!-- s: list -->
                    <ul class="board_list">
                        <c:choose>
