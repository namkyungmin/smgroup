...
<title>Manufacturing  | SM Group | Mobile</title>
</head>
    ...
    <div id="wrap" class="sub business manufacture">
        ...
        <div id="container">
            ...
            <div id="contents">
                ...
                <!--//e: tab_wrap -->
                <div class="cont_tit">
                    <h3>A better future through relentless research, development, and technology</h3>
                    <p class="sub_tit">SM Group puts the R&D of eco-friendly, high-efficiency products as a top priority, and grows around future values.</p>
                </div>
                <div class="section">
                    <div class="thumb_wrap">
                        <img src="/resource/eng/mobile/images/business/img_business_manufacture.jpg" alt="">
                    </div>
                    <!-- s: list -->
                    <ul class="board_list">
                        <c:choose>
