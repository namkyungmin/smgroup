...
<meta name="keywords" content="SM Group, SM Group Businees, SM Group Media&middot;Service, Media&middot;Service, Businees, SM Media·Service">
<meta name="description" content="This page describes SM Group’s media&middot;service business. We introduce many subsidiary companies in the media&middot;service sector.">
<title>Media&middot;Service  | SM Group | Mobile</title>
</head>
    ...
    <div id="wrap" class="sub business media">
        ...
        <div id="container">
            ...
            <div id="contents">
                ...
                <!--//e: tab_wrap -->
                <div class="cont_tit">
                    <h3>Expand the world, benefit lives</h3>
                    <p class="sub_tit">The SM Group is creating a bigger world with endless efforts to develop advanced IT  technologies, pioneer new markets, and globalize the market.</p>
                </div>
                <div class="section">
                    <div class="thumb_wrap">
                        <img src="/resource/eng/mobile/images/business/img_business_media.jpg" alt="">
                    </div>
                    <!-- s: list -->
                    <ul class="board_list">
                        <c:choose>
