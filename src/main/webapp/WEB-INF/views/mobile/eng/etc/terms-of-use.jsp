...
<title>Terms of Use  | SM Group | Mobile</title>
</head>
            ...
            <div id="contents">
                <div class="section">
                    <div class="top_wrap">
                        <div class="box">
                            <p>
                                Please read the user’s agreement (this rule) before using this website(<a href="/mobile/eng/index.do" title="Go to SM Group hompage">www.smgroup.co.kr</a>).<br> The website is provided by the SM Group for provision of information only. 
                            </p>
                        </div>
                    </div>
                    <div class="cont_wrap">
