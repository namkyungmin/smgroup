            ...
            <div id="contents">
				<div class="sec1 section">
					...
					<div class="anchor_wrap">
						<div class="sec_inner1 sec_inner">
							<div class="sec_txt">
								<p class="txt1">
									고객의 풍요로운 삶을 위한<br>품질, 환경, 안전 활동을 기본으로 인식 합니다.
								</p>
								<p class="txt2">SM그룹은 환경 규제와 법규를 준수하는 소극적 대응을 넘어, 조직 구성원들의 활동(제품, 서비스 및 절차)으로 고객에게 친환경 가치를 제공하고 지속가능한 미래를 선도하는 녹색경영을 실천하고 있습니다.</p>
							</div>
							<div class="sec_tit" data-motion="scaleType1">
								<div class="img_box"><img src="/resource/mobile/images/sustainability/environment/view_sec1_img1.jpg" alt=""></div>
				...
				<div class="sec2 section">
					...
					<div class="anchor_wrap">
						<div class="sec_inner1 sec_inner">
							<div class="sec_txt">
								<p class="txt1">친환경 건축, 친환경에너지 개발 등을 통해저탄소 녹색경영을 선도하는 기업이 되겠습니다. </p>
								<p class="txt2">SM그룹의 전 계열사는 녹색경영 활동 및 환경 캠페인 동참 등 녹색경영을 통한 사회적 환경경영 문화 조성에 적극 협조하고 있습니다.</p>
							</div>
						</div>
									...
									<div class="slide_wrap programs">
										<div class="slide_cont swiper-wrapper">
											<div class="slide swiper-slide">
												<p class="txt1">온실가스 배출 감축, 폐기물 발생 감량으로 <br>녹색경영 선도</p>
											</div>
											<div class="slide swiper-slide">
				...
				<div class="sec3 section">
					...
					<div class="anchor_wrap">
						<div class="sec_inner1 sec_inner">
							<div class="sec_txt">
								<p class="txt1">사업 활동에 의한 환경 영향을 최소화 하기 위하여 노력하고 있습니다.</p>
								<p class="txt2">SM그룹은 국내 및 관련 국가의 안전보건·환경 관련 법규 준수 및 이해관계자의 견해를 능동적으로 수용하고 친환경 요소의 발굴과 친환경 문화의 정착, 기후변화 대응을 위한 에너지 저감 활동의 자발적 참여를 지속적으로 실천해가고 있습니다. 그룹 임직원들은 고객 최고의 가치 창출과 풍요로운 삶을 영위할 수 있도록 품질, 환경, 안전을 기업 경영활동의 기본으로 인식하고 역량과 열정을 다하여 지속적인 개선활동을 성실히 수행해 나갈 것입니다.</p>
								<div class="btn_area">
									<a href="/resource/mobile/file/SMGROUP_Environment_Management_KR.pdf" target="_blank" class="btn_default download_btn">환경경영 다운로드</a>
								</div>
							</div>
							<div class="sec_tit" data-motion="scaleType1">
								<div class="img_box"><img src="/resource/mobile/images/sustainability/environment/view_sec3_img1.jpg" alt=""></div>
