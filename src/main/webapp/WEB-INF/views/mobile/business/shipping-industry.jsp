    ...
    <div id="wrap" class="sub business shipping">
        ...
        <div id="container">
            ...
            <div id="contents">
                ...
                <!--//e: tab_wrap -->
                <div class="cont_tit">
                    <h3>수송, 그 이상의 가치!<br>SM그룹이 힘을 보탭니다.</h3>
                    <p class="sub_tit">해운업은 단순히 화물을 옮기는 것이 아니라 산업과 문화를 움직입니다. SM그룹은 해운 문화를 창조하고 개척해 나아갑니다.</p>
                </div>
                <div class="section">
                    <div class="thumb_wrap">
                        <img src="/resource/mobile/images/business/img_business_shipping.jpg" alt="">
                    </div>
                    <!-- s: list -->
                    <ul class="board_list">
                        <c:choose>
