            ...
            <div id="contents">
                <div class="section">
                    <div class="top_wrap">
                        <div class="box">
                            <p>
                                이 웹 사이트(<a href="/" title="SM그룹 홈페이지 메인으로 이동">www.smgroup.co.kr</a>)를<br> 이용하기 전에 이용약관(“본 약관”)을<br> 반드시 읽어 주시기 바랍니다.<br> 본 사이트는 SM그룹이 제공하는 것으로<br> 오로지 정보 제공 목적으로만 사용됩니다.
                            </p>
                        </div>
                    </div>
                    <div class="cont_wrap">
                        ...
                        <div class="cont cont08">
                            <strong>본 약관은 2020년 8월 14일부터<br> 효력이 발생합니다.</strong>
                        </div>
                    </div>
                </div>
