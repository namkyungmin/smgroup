					...
					<div class="anchor_wrap">
						<div class="sec_inner1 sec_inner">
							...
							<div class="sec_txt">
								...
								<p class="txt2">
									동반성장은 종착지가 정해진 목표가 아니라 끊임없이 과제들을 발굴하고, <br>행동으로 실천해 나가야 하는 연속 과정입니다. SM그룹은 동반성장에 관한 <br>대내외의 다양한 아이디어와 제도들을 지속적으로 경영전반에 적극 반영해 <br class="n">나가며, <br class="b">SM가족 모두가 풍요로워지는 상생협력 문화를 만들어 가겠습니다.</p>
								<div class="roadmap" data-motion="staggerType1">
									<h3 data-role="m_elm">Roadmap 3 Steps</h3>
									<ol class="roadmap_lst">
										<li data-role="m_elm"><span><strong>설계</strong>동반성장 과제 발굴과 제도 마련</span></li>
										<li data-role="m_elm"><span><strong>시스템 정착화</strong>동반성장 시스템  확충</span></li>
										<li data-role="m_elm"><span><strong>동반성장 달성</strong>전사적 동반성장 가치 실현&middot;성과공유</span></li>
									</ol>
								</div>
							</div>
						</div>
					...
					<div class="anchor_wrap">
						<div class="sec_inner1 sec_inner">
							<div class="sec_txt">
								...
								<p class="txt2">끊임없는 상생발전 노력을 통해 우리 SM가족 모두가 최고의 품질을 갖도록 <br>SM그룹이 앞장서겠습니다. 우리가 함께 이룩해 낸 성과가 SM가족 모두의 <br class="b">자부심이 <br class="n">되고, SM 가족이란 사실이 경쟁력의 상징이 되는 아름다운 동반자 <br class="b">관계를 만들어 <br class="n">나가겠습니다.</p>
							</div>
						</div>
									...
									<div class="slide_wrap programs">
										<div class="slide_cont swiper-wrapper">
											<div class="slide swiper-slide">
												<dl>
													<dt>투명하고 공정하게 <br>협력사들과의 든든한 신뢰관계를 <br>구축하겠습니다.</dt>
													<dd>동반성장 실천의 주체로서 역량 및 소양을 향상시키고 <br>투명한 윤리경영을  토대로 공정한 거래질서를 확립<br>하겠습니다.</dd>
												</dl>
											</div>
											<div class="slide swiper-slide">
												<dl>
													<dt>보다 나은 성과 창출을 위해 <br>협력사들과 끊임없이 소통하고 <br>협력하도록 하겠습니다.</dt>
					...
					<div class="anchor_wrap">
						<div class="sec_inner1 sec_inner">
							...
							<div class="sec_txt">
								...
								<p class="txt2">
									SM그룹은 상생과 동반성장을 구호로만 외치지 않겠습니다. <br>“만남은 소중해야하고 인연은 아름다워야 한다“라는 옛 성현의 말씀처럼 <br class="n">협력사들과의 <br class="b">맺어진 소중한 인연을 긴 세월 동안 함께 하기 위해 SM그룹은 <br class="n">끊임없이 노력하겠습니다. <br class="b">협력사의 경쟁력이 우리의 경쟁력이라는 가치 아래 <br class="n">SM그룹은  동반성장을 위한 토대 마련에 <br class="b">더욱 노력하겠습니다. </p>
							</div>
						</div>
					</div>
				</div>
						...
						<div class="sec_inner1 sec_inner">
							<div class="inner">
								...
								<div class="sec_txt">
									...
									<p class="txt2">SM그룹 건설부문의 청사진을 제시하고 ‘안전’을 강조한 다양한 연중 캠페인 실시, <br class="n">협력사 <br class="b">제안제도 정착 등 동반성장을 목표로 천명한 바 있습니다. 이에 기술경쟁력 <br class="n">제고, 생산성 <br class="b">향상 및 원가절감 아이디어 도출을 위한 협력사 제안제도를 운영하여 <br class="n">비용절감은 물론 <br class="b">동반성장 및 거래 과정에서 건의사항 또는 애로사항도 함께 청취 <br class="n">함으로써 협력사와의 <br class="b">상생과 발전을 도모하고 있습니다.</p>
								</div>
							</div>
						</div>
									...
									<div class="slide_cont swiper-wrapper">
										<div class="slide swiper-slide">
											<dl>
												...
												<dd>원가경쟁력 확보를 위한 신공법·신기술·대안공법에 대한 협력사의 제안을 통해 <br>품질·안전관리에 반영하고 기술경쟁력을 높여 나가고 있습니다. </dd>
											</dl>
										</div>
										<div class="slide swiper-slide">
											<dl>
												<dt>현장경비 효율화</dt>
												<dd>효율적인 공정관리를 위한 현장 시공 프로세스 개선사항에 대해 청취하고 <br>이를 통한 원가절감을 추구하고 있습니다.</dd>
											</dl>
										</div>
										<div class="slide swiper-slide">
											<dl>
												<dt>건의함 운영</dt>
												<dd>업무혁신 제안 뿐 아니라 부당한 업무지시 및 강요, 부정부패 사례 신고 등 <br>애로사항에 대한 건의함을 운영하고 있습니다.</dd>
											</dl>
										</div>
									</div>
									<div class="slide_control">
