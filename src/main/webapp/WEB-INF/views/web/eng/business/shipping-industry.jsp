...
<title>Shipping Industry | SM Group</title>
</head>
    ...
    <div id="wrap" class="business sub shipping">
        ...
        <div id="container" class="type02">
            ...
            <div id="contents">
                <div class="contents_top">
                    ...
                    <div class="tab_wrap">
                        <ul>
                            ...
                            <li>
                                <a href="shipping-industry.do" class="on">Shipping Industry</a>
                            </li>
                            <li>
                ...
                <div class="cont_tit">
                    <h3>Shipping Industry</h3>
                    <p>More than just shipping, SM Group is with you!</p>
                </div>
                <div class="section">
                    <!-- s: list -->
