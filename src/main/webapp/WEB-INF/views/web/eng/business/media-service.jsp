...
<meta name="keywords" content="SM Group, SM Group Businees, SM Group Media·Service, Media·Service, Businees, SM Media·Service">
<meta name="description" content="This page describes SM Group’s media·service business. We introduce many subsidiary companies in the media·service sector.">
<title>Media&middot;Service  | SM Group</title>
</head>
    ...
    <div id="wrap" class="business sub media">
        ...
        <div id="container" class="type02">
            ...
            <div id="contents">
                <div class="contents_top">
                    ...
                    <div class="tab_wrap">
                        <ul>
                            ...
                            <li>
                                <a href="media-service.do" class="on">Media&middot;Service</a>
                            </li>
                            <li>
                ...
                <div class="cont_tit">
                    <h3>Media&middot;Service</h3>
                    <p>Expand the world, benefit lives</p>
                </div>
                <div class="section">
                    <!-- s: list -->
